            ...
            <div class="content-wrapper">
                ...
                <div class="page-header">
                    <div class="breadcrumb-line">
                        <ul class="breadcrumb">
                            <li><a href="#"><i class="icon-image5 position-left"></i>Client</a></li>
                ...
                <div class="content">
                    ...
                    <div class="panel panel-flat">
                        <div class="panel-heading">
                            <h5 class="panel-title">Client Creat</h5>

                        </div>
                        <div class="panel-body mt-5">
                            <form class="form-horizontal" action="contorller/clientController.php" method="POST"
                                ...
                                <fieldset class="content-group mt-10">
                                    ...
                                    $designations=mysqli_query($dbcon,$selectQuery);
                                    
                                    ?>
                                    <div class="form-group mt-10">
                                        <label class="control-label col-lg-2" for="clients_name">Client Name</label>
                                        <div class="col-lg-10">
                                            <input type="text" id="clients_name" class="form-control"
                                                name="clients_name">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mt-10">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="file" id="client_image" class="form-control"
                                                name="client_image">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mt-10">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="text" id="client_review" class="form-control"
                                                name="client_review">
                                        </div>
                                    </div>
                                ...
                                <div class="text-right">
                                    ...
                                    <a href="clients_list.php" class="btn btn-default ml-5">Back to List</a>
                                </div>
                            </form>
                        </div>
                    </div>
