...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <section id="home-section" class="hero">
        ...
        <div class="home-slider js-fullheight owl-carousel">
            <?php
            $bannerDataSql = "SELECT * FROM `banners` LIMIT 3";
            $bannerData = mysqli_query($dbcon,$bannerDataSql);
            if(!empty($bannerData)){
                ...
                <div class="container-fluid p-0">
                    <div class="row d-md-flex no-gutters slider-text js-fullheight align-items-center justify-content-end"
                        ...
                        <div class="one-third order-md-last img js-fullheight"
                            style="background-image:url(<?php echo 'admin/uploads/'.$bannerItem['images'];?>)">
                            <div class="overlay"></div>
                        </div>
                    ...
                    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        <a class="nav-link px-4 active" id="v-pills-1-tab" data-toggle="pill" href="#v-pills-1"
                            role="tab" aria-controls="v-pills-1" aria-selected="true"><span
                                class="mr-3 flaticon-ideas"></span> Business
                            Strategy</a>
                        ...
                        <a class="nav-link px-4" id="v-pills-4-tab" data-toggle="pill" href="#v-pills-4" role="tab"
                            aria-controls="v-pills-4" aria-selected="false"><span
                                class="mr-3 flaticon-web-design"></span> UI
                            Design</a>
                        <a class="nav-link px-4" id="v-pills-4-tab" data-toggle="pill" href="#v-pills-4" role="tab"
                            aria-controls="v-pills-4" aria-selected="false"><span
                                class="mr-3 flaticon-ux-design"></span> Ux
                            Design</a>
                        <a class="nav-link px-4" id="v-pills-5-tab" data-toggle="pill" href="#v-pills-5" role="tab"
                            aria-controls="v-pills-5" aria-selected="false"><span
                                class="mr-3 flaticon-innovation"></span>
                            Technology</a>
                    ...
                    <div class="tab-content pl-md-5" id="v-pills-tabContent">
                        ...
                        <div class="tab-pane fade show active py-5" id="v-pills-1" role="tabpanel"
                            ...
                            <p>Inventore fugit error iure nisi reiciendis fugiat illo pariatur quam sequi quod iusto
                                facilis officiis
                                nobis sit quis molestias asperiores rem, blanditiis! Commodi exercitationem vitae
            ...
            <div class="row">
                <div class="col-md-12 testimonial">
                    <div class="carousel-project owl-carousel">
                        <?php
                      $projectDataSql = "SELECT * FROM `our_projects` LIMIT 3";
                      $projectData = mysqli_query($dbcon,$projectDataSql);
                      if(!empty($projectData)){
                        foreach($projectData as $key=> $projecItem){
                      ...
                      ?>
                        ...
                        <div class="item">
                            <div class="project">
                                <div class="img">
                                    <img src="<?php echo'admin/uploads/'.$projecItem['project_thumb'];?>"
                                        class="img-fluid" alt="Colorlib Template">
                                    <div class="text px-4">
                                        <h3><a href="#"></a>Project link</h3>
                                        <h3><?php echo $projecItem['project_name'];?></h3>
                                        <span></span>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-md-12">
                    <div class="carousel-testimony owl-carousel ftco-owl">
                        ...
                        <div class="item">
                            <div class="testimony-wrap text-center py-4 pb-5">
                                <div class="user-img"
                                    style="background-image:url(images/xperson_4.jpg.pagespeed.ic.sgz97bcjv4.jpg)">
                                    <span class="quote d-flex align-items-center justify-content-center">
                                        <i class="icon-quote-left"></i>
                                    </span>
                                </div>
    ...
    <section class="ftco-section contact-section ftco-no-pb" id="contact-section">
        <div class="container">
            ...
            <div class="row d-flex contact-info mb-5">
                <?php
                    $selectQuery= "SELECT * FROM contact_us LIMIT 1";
                    $contact_us=mysqli_query($dbcon,$selectQuery);
                ...
                <div class="col-md-6 col-lg-3 d-flex ftco-animate">
                    <div class="align-self-stretch box p-4 text-center">
                        ...
                        <p><?php echo $contact['address_details'];?></p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3 d-flex ftco-animate">
                    <div class="align-self-stretch box p-4 text-center">
                        ...
                        <p><a href="tel://1234567920"><?php echo $contact['contact_number'];?></a></p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3 d-flex ftco-animate">
                    <div class="align-self-stretch box p-4 text-center">
                        ...
                        <p><a
                                href="/#bdd4d3dbd2fdc4d2c8cfced4c9d893ded2d0"><span><?php echo $contact['email_address'];?></span></a>
                        </p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3 d-flex ftco-animate">
                    <div class="align-self-stretch box p-4 text-center">
                        ...
                        <p><a href="#"><?php echo $contact['website_name'];?></a></p>
                    </div>
                </div>
                <?php } ?>
            </div>
    ...
    <script>
    eval(mod_pagespeed_QoQw5mEjcw);
    </script>
    <script>
    eval(mod_pagespeed_vJQZATLKX_);
    </script>
    <script>
    eval(mod_pagespeed__uMKjXdTTb);
    </script>
    <script src="script/script_two.js"></script>
    <script>
    eval(mod_pagespeed_MopiGN0l60);
    </script>
    <script>
    eval(mod_pagespeed_yqyi7SROoB);
    </script>
    <script>
    eval(mod_pagespeed_B_8AKRgOLa);
    </script>
    <script>
    eval(mod_pagespeed_KlaBTxBGz$);
    </script>
    <script src="script/script_three.js"></script>
    <script>
    eval(mod_pagespeed_xJO9nXgGsQ);
    </script>
    <script>
    eval(mod_pagespeed_keatkQTnas);
    </script>
    <script>
    eval(mod_pagespeed_GaS9YCK1um);
    </script>
    <script>
    eval(mod_pagespeed_RTyTkD0doj);
    </script>
    <script src="maps/api/map.js"></script>
    <script>
    eval(mod_pagespeed_EpcOxjoUJz);
    </script>
    <script>
    eval(mod_pagespeed_hwvKDLnz23);
    </script>
    ...
    <script defer src="js/beacon.min.js"
        data-cf-beacon='{"rayId":"680bfffb4b68fdfe","token":"cd0b4b3a733644fc843ef0b185f98241","version":"2021.8.1","si":10}'>
    </script>
    <center>
